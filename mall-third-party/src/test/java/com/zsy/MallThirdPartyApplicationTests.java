...
class MallThirdPartyApplicationTests {
    ...
    void contextLoads() throws FileNotFoundException {
        ossClient.putObject("guli-bobo", "hh.png", new FileInputStream("C:\\Users\\JPF\\Pictures\\ceshi.jpeg"));
    }
    ...
    public void testUpload() throws FileNotFoundException {
        ...
        String accessKeyId = "LTAI5t75GywVjmswHjUX3aCj";
        String accessKeySecret = "JYdXthuuFqzqtX932FRiHinuIEP8Sp";
        // 创建OSSClient实例。
        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        // 上传文件流。
        InputStream inputStream = new FileInputStream("C:\\Users\\JPF\\Pictures\\other.jpg");
        ossClient.putObject("guli-bobo", "other.jpg", inputStream);
        // 关闭OSSClient。
        ossClient.shutdown();
